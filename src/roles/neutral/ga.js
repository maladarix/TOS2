...
class gardian {
    constructor(){
        ...
        this.hab = `Si votre cible est tuée, vous deviendrez un survivant sans gilets pare-balles. Deux fois par partie, vous pouvez guérir et purger votre cible. Cela peut être fait depuis la tombe. Surveiller un joueur ignore la prison.`
        this.defense = 0
        this.attack = 0
    }
